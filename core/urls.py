...
from core.views.OrderDetailView import OrderDetailView
...
from core.views.ProductListView import ProductListView
...
urlpatterns = [
    ...
    path('products/<int:supplier_id>/', ProductListView.as_view(), name='product-list'),
    path('products/category/<int:category_id>/<int:supplier_id>/', ProductListView.as_view(), name='product_list_category'),
    path('products/category/product_list_subcategory/<int:subcategory_id>/<int:supplier_id>/', ProductListView.as_view(), name='product_list_subcategory'),
